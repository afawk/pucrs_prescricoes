...
Funcionalidade: UC04 - Prescrever Medicamentos
  ...
  Cenário: TS04a - Prescrever um medicamento com sucesso:
  ...
  Cenário: TS04b - Parametrização de medicamentos:
    Dado que eu estou logado no sistema
    E que o paciente "João Silva" está em atendimento na unidade "Pediatria"
  ...
  Cenário: TS04c - Prescrever um medicamento com falha - via não informada:
    Dado que eu estou logado no sistema
    E que o paciente "João Silva" está em atendimento na unidade "Pediatria"
    E que eu iniciei uma nova prescrição
  ...
  Cenário: TS04d - Prescrever um medicamento com falha - quantidade não informada:
    Dado que eu estou logado no sistema
    E que o paciente "João Silva" está em atendimento na unidade "Pediatria"
    E que eu iniciei uma nova prescrição
  ...
  Cenário: TS04e - Prescrever um medicamento com falha - frequência não informada:
    Dado que eu estou logado no sistema
    E que o paciente "João Silva" está em atendimento na unidade "Pediatria"
    E que eu iniciei uma nova prescrição
  ...
  Cenário: TS04f - Cancelar prescrição de medicamento durante processo de prescrição:
    Dado que eu estou logado no sistema
    E que o paciente "João Silva" está em atendimento na unidade "Pediatria"
    E que eu iniciei uma nova prescrição
